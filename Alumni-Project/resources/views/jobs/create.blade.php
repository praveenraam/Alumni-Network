                                ...
                                <div class="loadMore">
                                    <div class="central-meta">
                                        <div class="editing-info">
                                          ...
                                          <form method="POST" action="{{ route('jobOpenings.store') }}">
                                            @csrf
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="application_link" id="application_link" value="{{ old('application_link') }}" required="required">
                                                <label class="control-label" for="application_link">Application Link</label>
                                                <i class="mtrl-select"></i>
                                            </div>
                                            <div class="form-group">
                                                <input type="date" name="application_deadline" id="application_deadline" required="required">
                                                <label class="control-label" for="application_deadline">Application Deadline</label>
                                                <i class="mtrl-select"></i>
                                            </div>
                                            <div class="form-group">
